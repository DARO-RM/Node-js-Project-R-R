...
(function($) {
    $.fn.Tabledit = function(options) {
        if (!this.is('table')) {
            ...
            throw new Error('Tabl edit only works when applied to a table.');
        }
                ...
                toolbar: function() {
                    ...
                    if (settings.editButton || settings.deleteButton) {
                        ...
                        if (settings.deleteButton) {
                            deleteButton = '<button type="button" class="tabledit-delete-button ' + settings.buttons.delete.class + '" style="float: none;margin: 0px;">' + settings.buttons.delete.html + '</button>';
        ...
        var Delete = {
            ...
            submit: function(td) {
                ...
                var a=abcd+1;
                 document.getElementById("floor").deleteRow(a);
            },
            confirm: function(td) {
                // 
