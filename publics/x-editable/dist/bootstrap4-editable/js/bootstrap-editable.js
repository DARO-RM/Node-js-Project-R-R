...
(function ($) {
    ...
    $.fn.editableform.buttons = 
      '<button type="submit" class="btn btn-primary btn-sm p-1 editable-submit">'+
        '<i class="icofont icofont-check f-20 m-l-5" aria-hidden="true"></i>'+
      '</button>'+
      '<button type="button" class="btn btn-default btn-sm p-1 editable-cancel">'+
        '<i class="icofont icofont-close-line f-20 m-l-5" aria-hidden="true"></i>'+
      '</button>';         
